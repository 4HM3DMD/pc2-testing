...
(function (root) {
    ...
    var STRINGS = deepFreeze({
        ...
        settings: {
            ...
            // beta.3.67 — Phase 7 auto-heal status panel.
            snapshot_heading:             'Auto-heal state snapshots',
            snapshot_load_failed:         'Couldn’t load snapshot status.',
            snapshot_status:              'Service status',
            snapshot_enabled:             'Enabled',
            snapshot_disabled:            'Disabled',
            snapshot_on:                  'On',
            snapshot_off:                 'Off',
            snapshot_auto_restore:        'Auto-restore on desync',
            snapshot_cadence:             'Cadence',
            snapshot_retention:           'Retention',
            snapshot_count:               'Stored snapshots',
            snapshot_count_suffix:        'snapshots',
            snapshot_latest:              'Latest',
            snapshot_none_yet:            '(no snapshots yet)',
            snapshot_help:                'ENM takes a small backup of the chain’s DPoS state every hour. If the chain ever gets stuck because of a state-vs-ledger desync, the auto-heal restores the most recent snapshot and lets the chain catch up — much cheaper than a full bootstrap. You can also take or restore manually below.',
            snapshot_take_now:            'Take snapshot now',
            snapshot_taking:              'Capturing…',
            snapshot_take_done:           'Snapshot captured.',
            snapshot_take_failed:         'Snapshot failed.',
            snapshot_restore_now:         'Restore from latest snapshot',
            snapshot_restoring:           'Restoring…',
            snapshot_restore_done:        'Snapshot restored.',
            snapshot_restore_failed:      'Restore failed.',
            snapshot_restore_confirm:     'This will stop the chain, replace its current state files with the most recent snapshot, and restart. Use this only if the chain is stuck. Continue?',
