...
(function (root) {
    ...
    var STRINGS = deepFreeze({
        ...
        settings: {
            ...
            rpc_creds_intro:    'Credentials, connection URLs, and the IP allow-list for external wallets, dApps, and monitoring tools. Treat the password like a key — anyone with the URL and credentials can submit transactions.',
            ...
            rpc_url_same_machine:   'Same machine',
            rpc_url_private_network:'Private network',
            rpc_url_public_internet:'Public internet',
            rpc_url_public_warn:    'Reachable from the internet — add a whitelist entry below before clients can connect.',
            rpc_white_apply_btn:    'Apply changes',
            rpc_white_help:         'Clients connect ONLY from these addresses. Add IPs (e.g. 192.168.1.42) or CIDR ranges (e.g. 192.168.1.0/24). Empty = all blocked. 0.0.0.0/0 = any (not recommended).',
